...
import { faUserCheck, faChartLine, faUsers, faArrowLeft, faHome, faSignOutAlt, faChartArea } from '@fortawesome/free-solid-svg-icons';
      ...
      <ul className="admin-functions-list">
        ...
        <li>
          <Link to="/admin/charts">
            <button className="admin-btn">
              <FontAwesomeIcon icon={faChartArea} /> Ver Gráficas
            </button>
          </Link>
        </li>
      </ul>
